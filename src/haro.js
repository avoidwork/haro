const node = typeof process !== "undefined" && typeof process.nextTick === "function",
	webWorker = typeof Worker !== "undefined" ? Worker : node ? require("tiny-worker") : null,
	webWorkerError = "Web Worker not supported",
	adapter = {};

import {blob, cast, clone, concatURI, createPatch, delIndex, each, functions, keyIndex, merge, setIndex, toObjekt, uuid} from "./utility";
...
export default function factory (data = null, config = {}) {
