...
class Transaction {
	 ...
	 */
	constructor (id = randomUUID(), options = {}) {
		this.id = id;
...
}export{Constraints,DataStream,DataTypes,ErrorRecovery,FieldConstraint,Haro,ImmutableStore,IndexTypes,IsolationLevels,QueryTypes,Record,RecordCollection,RecordFactory,RetentionPolicies,Schema,Haro as default,haro};